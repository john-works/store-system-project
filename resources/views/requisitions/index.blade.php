                ...
                <section class="section">
                    <div class="card">
                        ...
                        <div class="card-footer text-end">
                                <a href="{{ route('requisitions.create') }}" class="btn btn-secondary">Add New Requisition request</a>
                            </div>
                        <div class="card-body">
                                ...
                                <tr>
                                   <td>{{ $requisition->id }}</td>
                                    ...
                                    <td>
                                        ...
                                        </form> --}} <span class="action-icon" data-id="{{ $requisition->id }}">📄</span>
                                    </td>
                                </tr>
                            @empty
                                <tr>
...
<script>
    ...
    function handleAction(action) {
        ...
        if (action === "view") {
            window.location.href = `/requisitions/${id}`;
        } else if (action === "edit") {
            window.location.href = `/requisitions/${id}/edit`;
