            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('disposals.index') }}">Disposal</a></li>
        ...
        <section class="section">
            <div class="card border-danger shadow-sm">
                ...
                <div class="card-body text-center">
                    <h4 class="text-dark mb-3">{{ $disposals->procument_subject }}</h4>
                    <p>
                        <strong>Supplier:</strong> {{ $disposals->supplier->supplier_name ?? 'N/A' }}<br>
                        <strong>Procurement Type:</strong> {{ $disposals->procurement_type }}<br>
                        <strong>Amount:</strong> UGX {{ $disposals->amount_cost}}<br>
                        <strong>Contract Period:</strong> {{ $disposals->start_date }}
                    </p>
