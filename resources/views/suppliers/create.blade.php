                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form action="{{ route('suppliers.store') }}" method="POST" class="form">
                                            ...
                                            <div id="supplier-forms">
                                                <div class="supplier-group row border p-3 mb-3 rounded">
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="type_of_good" class="form-control"
                                            ...
                                            <div class="col-12 d-flex justify-content-start mb-3">
                                                <button type="button" id="addSupplier" class="btn btn-success me-2">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            addBtn.addEventListener("click", function () {
                const firstGroup = container.querySelector(".supplier-group");
