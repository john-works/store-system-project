                                                 ...
                                                 <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="request_item" class="form-control"
                                                            value="{{ old('request_item', $service->request_item) }}" name="request_item" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" id="invoice_number" class="form-control"
                                                           value="{{ old('invoice_number', $service->invoice_number) }}" name="invoice_number" prequired>
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" id="invoice_value" class="form-control"
                                                             value="{{ old('invoice_value', $service->invoice_value) }}"name="invoice_value" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="item__description" class="form-control"
                                                           value="{{ old('item__description', $service->item__description) }}" name="item__description" required>
                                                    </div>
                                                </div>
