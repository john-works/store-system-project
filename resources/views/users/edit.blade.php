                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="phone" class="form-control"
                                                            value="{{ old('name', $user->name) }}" name="phone" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="password" class="form-control"
                                                            value="{{ old('password', $user->password) }}" name="password" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select type="text" id="department" class="form-control"
                                                            value="{{ old('department', $user->department) }}" name="department" required>
