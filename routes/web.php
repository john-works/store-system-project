...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/contracts/info', [ContractController::class, 'info'])->name('contracts.info')->middleware('permission:contracts,index');
...
// ======================= Item Routes =======================
Route::middleware('auth')->group(function () {
    Route::get('/items', [ItemController::class, 'index'])->name('items.index')->middleware('permission:items,index');
...
// ======================= Goods Routes =======================
Route::middleware('auth')->group(function () {
    Route::get('/goods', [GoodController::class, 'index'])->name('goods.index')->middleware('permission:goods,index');
...
// ======================= Borrowing Routes =======================
Route::middleware('auth')->group(function () {
    Route::get('/borrowings', [BorrowingController::class, 'index'])->name('borrowings.index')->middleware('permission:borrowings,index');
...
// ======================= Movement Routes =======================
Route::middleware('auth')->group(function () {
    Route::get('/moverments', [MovementController::class, 'index'])->name('moverments.index')->middleware('permission:moverments,index');
...
// ======================= Requisition Routes =======================
Route::middleware('auth')->group(function () {
    Route::get('/requisitions', [RequisitionController::class, 'index'])->name('requisitions.index')->middleware('permission:requisitions,index');
...
// ======================= Disposal Routes =======================
Route::middleware('auth')->group(function () {
    Route::get('/disposals', [DisposalController::class, 'index'])->name('disposals.index')->middleware('permission:disposals,index');
...
route::middleware('auth')->group(function () {
    Route::get('/workflow_stepss', [WorkflowstepController::class, 'index'])->name('workflow_stepss.index')->middleware('permission:workflow_stepss,index');
});
